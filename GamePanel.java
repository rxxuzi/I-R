...
public class GamePanel extends JPanel implements ActionListener{
	...
	static final int UNIT_SIZE = 50;//É}ÉXÇÃëÂÇ´Ç≥(SCREEN_WIDTHÇÃñÒêî)
	static final int GAME_UNITS = (SCREEN_WIDTH*SCREEN_HEIGHT)/UNIT_SIZE;
	static final int DELAY = 120;//è¨Ç≥Ç¢ÇŸÇ«ëÅÇ≠Ç»ÇÈ
	...
	public void draw(Graphics g) {
		for(int i = 0 ; i <SCREEN_HEIGHT/UNIT_SIZE ; i ++) {
			g.drawLine(i*UNIT_SIZE, 0 , i*UNIT_SIZE , SCREEN_HEIGHT);//ècê¸Çï`âÊ
			g.drawLine(0 , i*UNIT_SIZE , SCREEN_WIDTH , i*UNIT_SIZE);//â°ê¸Çï`âÊ
		}
